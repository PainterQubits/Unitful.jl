...
@generated function promote_op{S,T,D,U}(op, ::Type{AbstractQuantity{S}},
    ::Type{Quantity{T,D,U}})
...
# quantity, number
@generated function promote_op{R<:Number,S,D,U}(op,
...
@generated function promote_op{S,T}(op, ::Type{AbstractQuantity{S}},
    ::Type{AbstractQuantity{T}})
...
@generated function promote_op{S,T<:Number}(op, ::Type{AbstractQuantity{S}},
    ::Type{T})
...
# units, number
@generated function promote_op{R<:Number,S<:Units}(op,
    x::Type{R}, y::Type{S})
