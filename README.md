...
- [UnitfulIntegration.jl](https://github.com/PainterQubits/UnitfulIntegration.jl) (deprecated): Enables use of Unitful quantities with [QuadGK.jl](https://github.com/JuliaMath/QuadGK.jl). (QuadGK.jl ≥ v2.7.0 supports Unitful quantities out of the box.)
